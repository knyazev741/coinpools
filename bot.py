...
async def createpost(title, per_hour, img_src):
    try:
        ...
        bronze_earnings = base_earnings * multipliers["Bronze"]
        silver_earnings = base_earnings * multipliers["Silver"]
        gold_earnings = base_earnings * multipliers["Gold"]
        platinum_earnings = base_earnings * multipliers["Platinum"]
